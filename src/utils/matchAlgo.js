...
//     const getFieldText = (field) => field ? field : "";  // Default to empty string if undefined

//     // Use default values for missing fields
//     const interestsEmbedding1 = await getEmbedding(model, getFieldText(profile1.interests));
//     const interestsEmbedding2 = await getEmbedding(model, getFieldText(profile2.interests));
//     const lifestyleEmbedding1 = await getEmbedding(model, getFieldText(profile1.lifestyle));
//     const lifestyleEmbedding2 = await getEmbedding(model, getFieldText(profile2.lifestyle));
//     const introEmbedding1 = await getEmbedding(model, getFieldText(profile1.intro));
//     const introEmbedding2 = await getEmbedding(model, getFieldText(profile2.intro));
...
//     const educationScore = profile1.education === profile2.education ? 1 : 0;
//     const languageScore = profile1.languages === profile2.languages ? 1 : 0;
//     const completenessScore = (profile1.completeness || 0 + profile2.completeness || 0) / 2;
